...
This repository includes the analysis workflow for the manuscript entitled "Working conditions and mental health among doctors and nurses in the European Union, Iceland, and Norway: a cross-sectional survey". The analyses were conducted by Roberto Mediavilla and Vicente Arrona at the WHO Collaborating Centre, Universidad Autónoma de Madrid, Spain.
